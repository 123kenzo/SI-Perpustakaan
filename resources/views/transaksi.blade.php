        ...
        <div class="overflow-x-auto bg-white shadow rounded-lg">
            <table class="table-auto w-full border-collapse border border-gray-300">
                ...
                <tbody class="bg-gray-100">
                    ...
                    <tr>
                        <td class="px-4 py-2 text-center border text-center border-gray-300">{{ $transaksi->No_Pinjaman }}</td>
                        <td class="px-4 py-2 text-center border text-center border-gray-300">{{ $transaksi->Nama }}</td>
                        <td class="px-4 py-2 text-center border text-center border-gray-300">{{ $transaksi->Id_anggota }}</td>
                        <td class="px-4 py-2 text-center border text-center border-gray-300">{{ $transaksi->no_buku }}</td>
                        <td class="px-4 py-2 text-center border text-center border-gray-300">{{ $transaksi->tgl_pinjam }}</td>
                        <td class="px-4 py-2 text-center border border-gray-300">{{ $transaksi->tgl_kembali }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
