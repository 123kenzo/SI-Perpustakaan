        ...
        <div class="overflow-x-auto bg-white shadow rounded-lg">
          <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            <tbody class="bg-gray-100">
                ...
                <tr>
                    <td class="px-4 py-2 text-center border border-gray-300 w-[10px]">{{ $anggota->id_anggota }}</td>
                    <td class="px-4 py-2 text-center border border-gray-300 w-[25px]">{{ $anggota->nama }}</td>
                    <td class="px-4 py-2 text-center border border-gray-300">{{ $anggota->alamat }}</td>
                    <td class="px-4 py-2 text-center border border-gray-300 w-[25px]">{{ $anggota->no_telp }}</td>
                    <td class="px-4 py-2 text-center border border-gray-300 w-[25px]">{{ $anggota->tgl_lahir }}</td>
                    <td class="px-4 py-2 text-center border border-gray-300 w-[150px]">
                        <a href="{{ route('anggota.edit', $anggota->id_anggota) }}" class="inline-block bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">
                            Edit
                        </a> 
                        |
                        <form action="{{ route('anggota.destroy', $anggota->id_anggota) }}" method="POST" class="inline">
                            @csrf
                            @method('DELETE')
