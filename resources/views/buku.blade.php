        ...
        <div class="overflow-x-auto bg-white shadow rounded-lg mt-6">
          <table class="table-auto w-full border-collapse border border-gray-300">
            ...
            <tbody class="bg-gray-100">
              ...
              <tr>
                <td class="px-4 py-2 text-center border border-gray-300 w-[10px]">{{ $buku->id }}</td>
                <td class="px-4 py-2 text-center border border-gray-300">{{ $buku->no_buku }}</td>
                <td class="px-4 py-2 text-center border border-gray-300">{{ $buku->judul }}</td>
                <td class="px-4 py-2 text-center border border-gray-300">{{ $buku->pengarang }}</td>
                <td class="px-4 py-2 text-center border border-gray-300">{{ $buku->jenis_buku }}</td>
              </tr>
              @endforeach
            </tbody>
          </table>
