...
<div class="min-h-full">
    ...
    <main>
      ...
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        <br>
        <p class="text-lg text-gray-700 justify-text">
          Perpustakaan adalah suatu tempat yang menyediakan berbagai jenis buku, majalah, jurnal, dan media informasi lainnya untuk dibaca atau dipinjam oleh pengunjung. Selain sebagai pusat informasi, perpustakaan juga berfungsi sebagai wadah pembelajaran, penelitian, dan pengembangan literasi. Melalui fasilitas ini, masyarakat dapat mengakses berbagai sumber pengetahuan yang penting untuk mendukung pendidikan dan pengembangan diri.
        </p>
        <p class="text-lg text-gray-700 justify-text mt-4">
          Perpustakaan modern sering kali dilengkapi dengan berbagai fasilitas digital, seperti komputer, internet, serta e-book yang memudahkan pengunjung dalam memperoleh informasi secara cepat dan efisien. Di samping itu, perpustakaan juga menjadi tempat yang mendukung kegiatan literasi masyarakat, mulai dari anak-anak hingga orang dewasa.
        </p>
      </div>
    </main>
  </div>
  </body>
</html><?php /**PATH C:\laragon\www\perpustakaan\resources\views/index.blade.php ENDPATH**/ ?>