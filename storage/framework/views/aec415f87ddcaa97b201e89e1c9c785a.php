            ...
            <div class="flex items-center">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                    ...
                    <a href="#" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white" aria-current="page">Buku</a>
        ...
        <div 
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form method="POST" action="<?php echo e(route('buku.store')); ?>">
                  <?php echo csrf_field(); ?> 
                      <div class="mb-4">
                        <label for="no_buku" class="block text-sm font-medium">Nomor Buku</label>
                        <input 
                            type="text" 
                            id="no_buku" 
                            name="no_buku" 
                    ...
                    <div class="mb-4">
                        <label for="pengarang" class="block text-sm font-medium">Pengarang</label>
                        <input 
                            type="text" 
                            id="pengarang" 
                            name="pengarang" 
                    ...
                    <div class="mb-4">
                        <label for="jenis_buku" class="block text-sm font-medium">Jenis Buku</label>
                        <input 
                            type="text" 
                            id="jenis_buku" 
                            name="jenis_buku" 
          ...
          <table class="table-auto w-full border-collapse border border-gray-300">
            <thead class="bg-gray-800 text-white">
              <tr>
                ...
                <th class="px-4 py-2 text-center w-1/6 border border-gray-300">Nomor Buku</th>
                <th class="px-4 py-2 text-center w-1/4 border border-gray-300">Judul</th>
                <th class="px-4 py-2 text-center w-1/4 border border-gray-300">Pengarang</th>
                <th class="px-4 py-2 text-center w-1/6 border border-gray-300">Jenis Buku</th>
              </tr>
            </thead>
            <tbody class="bg-gray-100">
              ...
              <tr>
                <td class="px-4 py-2 text-center border border-gray-300 w-[10px]"><?php echo e($buku->id); ?></td>
                <td class="px-4 py-2 text-center border border-gray-300"><?php echo e($buku->no_buku); ?></td>
                <td class="px-4 py-2 text-center border border-gray-300"><?php echo e($buku->judul); ?></td>
                <td class="px-4 py-2 text-center border border-gray-300"><?php echo e($buku->pengarang); ?></td>
                <td class="px-4 py-2 text-center border border-gray-300"><?php echo e($buku->jenis_buku); ?></td>
              </tr>
...
</html><?php /**PATH C:\laragon\www\perpustakaan\resources\views/buku.blade.php ENDPATH**/ ?>